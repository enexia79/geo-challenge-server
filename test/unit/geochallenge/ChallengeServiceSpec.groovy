...
class ChallengeServiceSpec extends Specification {
    ...
    def setup() {
		...
		def point = new Point(longitude: 20.0, latitude: 3.5, challenge: Challenge.get(1), content: "Testing Data")
    ...
    void "test create"() {
		...
		when:
			def pointInfo	= [title: "title", longitude: 1.0, latitude: 2.0, content: "Your not done"]
